...
package org.atmofox.tv.ui.robots
...
import org.atmofox.tv.helpers.NestedScrollToAction
import org.atmofox.tv.helpers.RecyclerViewHelpers
import org.atmofox.tv.channels.DefaultChannelTileViewHolder
 ...
 *
 * @sample org.atmofox.tv.session.ClearSessionTest.WHEN_data_is_cleared_THEN_back_and_forward_should_be_unavailable
 */
...
private fun overlay() = onView(withId(R.id.channelsContainer))
