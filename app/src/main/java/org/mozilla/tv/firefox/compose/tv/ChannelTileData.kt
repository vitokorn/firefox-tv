...
package org.mozilla.tv.firefox.compose.tv
        ...
        return when (tileSource) {
            TileSource.BUNDLED, TileSource.CUSTOM ->
                context.resources.getString(
                    org.mozilla.tv.firefox.R.string.pinned_tiles_channel_remove_title,
                    title
                )
            TileSource.NEWS ->
                context.resources.getString(
                    org.mozilla.tv.firefox.R.string.news_channel_remove_title,
                    title
                )
            TileSource.SPORTS ->
                context.resources.getString(
                    org.mozilla.tv.firefox.R.string.sports_channel_remove_title,
                    title
                )
            TileSource.MUSIC ->
                context.resources.getString(
                    org.mozilla.tv.firefox.R.string.music_channel_remove_title,
                    title
                )
        }
    }
